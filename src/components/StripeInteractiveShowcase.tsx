            ...
            <div className="mt-6 pt-4 border-t border-[var(--color-border)]/70 space-y-2">
              ...
              <div className="rounded-[6px] border border-[var(--color-border)] bg-[var(--color-panel-subtle)] p-2.5 space-y-2 text-[10px] font-mono">
                ...
                <div className="flex items-center justify-between text-[var(--color-text-primary)]">
                  <span className="truncate max-w-[100px]">Suffolk Health Parcel</span>
                  <span className="text-[#533AFD] font-bold">310 CMR</span>
                  <span className="text-[#057A55] font-bold">$3212.4ms</span>
                </div>
                <div className="flex items-center justify-between text-[var(--color-text-primary)]">
                  <span className="truncate max-w-[100px]">Chesapeake Dock</span>
                  <span className="text-[#533AFD] font-bold">33 USC</span>
                  <span className="text-[#057A55] font-bold">$1818.1ms</span>
                </div>
                <div className="flex items-center justify-between text-[var(--color-text-primary)]">
                  <span className="truncate max-w-[100px]">BioTech Cleanroom</span>
                  <span className="text-[#533AFD] font-bold">310 CMR</span>
                  <span className="text-[#057A55] font-bold">$149.2ms</span>
                </div>
                <div className="flex items-center justify-between text-[var(--color-text-primary)]">
                  <span className="truncate max-w-[100px]">Midwest Substation</span>
                  <span className="text-[#533AFD] font-bold">FERC 888</span>
                  <span className="text-[#057A55] font-bold">$4214.5ms</span>
                </div>
              </div>
